...
export default function RangeInput({
	...
	return (
		<div className={classNames("relative h-5 [&:disabled::-webkit-slider-thumb]:hidden", className)}>
			<div className={"absolute z-[0] top-1/2 -translate-y-1/2 h-1 w-full rounded bg-[var(--gray300)] pointer-events-none"} />
			{!hideFill && <div className={"absolute z-[0] top-1/2 -translate-y-1/2 h-1 w-full rounded bg-[var(--primary100)] pointer-events-none"} style={getFillStyle()} />}
			<input
