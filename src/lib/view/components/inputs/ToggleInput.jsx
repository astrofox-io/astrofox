		...
		<div className={"flex"}>
			<div
				className={classNames(
					"relative h-[17px] w-8 rounded-[17px] bg-[var(--input-bg-color)] border border-[var(--input-bg-color)] transition-[background-color_0.25s] order-[1] [&:before]:absolute [&:before]:top-1/2 [&:before]:left-0 [&:before]:-translate-y-1/2 [&:before]:content-[''] [&:before]:w-[15px] [&:before]:h-[15px] [&:before]:rounded-[15px] [&:before]:bg-[var(--text100)] [&:before]:border [&:before]:border-[var(--input-border-color)] [&:before]:shadow-[0_0_2px_rgba(0,_0,_0,_0.3)] [&:before]:transition-[left_0.25s]",
					{
