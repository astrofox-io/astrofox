...
export default function Toolbar() {
	...
	return (
		<div
			className="flex flex-col w-10 shrink-0 py-2 px-0.5 gap-1 bg-gray75 border-r border-r-gray300 items-center"
			aria-label="Tools"
		>
					...
					<div key={item.type} className="relative flex justify-center">
						<button
							...
							className={classNames(
								"w-8 h-8 border-0 p-0 rounded-md bg-transparent text-text300 inline-flex items-center justify-center cursor-default",
								{
