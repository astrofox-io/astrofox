...
export default function About({ onClose }) {
	return (
		<div className={"text-text100 text-center cursor-default p-[30px] bg-[url(/images/about_bg.jpg)_no-repeat_center_center_fixed]"}>
			...
			<div className={"mb-[30px] text-text200"}>{"Copyright \u00A9 Mike Cao"}</div>
			<div className={"mt-5"}>
