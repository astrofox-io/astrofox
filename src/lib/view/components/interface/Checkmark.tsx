		...
		{({ circleOffset, pathOffset }) => (
			...
			>
				<svg aria-hidden="true" className={"inline-block [transform-origin:center_center]"} viewBox="0 0 72 72">
					<circle
						className={"stroke-violet-600 [stroke-width:2] [fill:none] [stroke-dasharray:240px,_240px] [stroke-dashoffset:240px]"}
						cx="36"
						cy="36"
						r="35"
					...
					/>
					<path
						className={"stroke-violet-600 [stroke-width:2] [fill:none] [stroke-dasharray:50px,_50px] [stroke-dashoffset:50px]"}
