    ...
    <div className="mx-2 my-1.5 overflow-hidden rounded bg-neutral-900/70">
      <div className="flex items-center gap-1 pr-2.5">
        <button
          type="button"
          aria-expanded={open}
          className="flex min-w-0 flex-1 cursor-pointer items-center gap-1 px-1.5 py-1.5 text-left text-[10px] uppercase tracking-[0.12em] text-neutral-400 hover:text-neutral-100"
