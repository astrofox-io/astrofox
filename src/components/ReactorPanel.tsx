...
const staticOutputModes = ['Static', 'Static Forward', 'Static Reverse', 'Static Cycle'];
  ...
  return (
    ...
    >
      ...
      <div className={'flex flex-row justify-center items-center gap-2 overflow-auto'}>
        ...
        <div
          className={'ml-2.5 shadow-[inset_0_0_20px_rgba(0,_0,_0,_0.5)] border border-neutral-800'}
        >
