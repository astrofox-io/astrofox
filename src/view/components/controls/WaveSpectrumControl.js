...
function WaveSpectrumControl({
  ...
  return (
    <Control label="Wave Spectrum" active={active} displayName={displayName}>
      <Option>
        <Label text="Max dB" />
        <NumberInput
          name="maxDecibels"
      ...
      <Option>
        <Label text="Stroke" />
        <ToggleInput name="stroke" value={stroke} onChange={onChange} />
      </Option>
      <Option>
      ...
      <Option>
        <Label text="Fill" />
        <ToggleInput name="fill" value={fill} onChange={onChange} />
      </Option>
      <Option>
      ...
      <Option>
        ...
        <ToggleInput name="taper" value={taper} onChange={onChange} />
      </Option>
      <Option>
        <Label text="X" />
        <NumberInput
